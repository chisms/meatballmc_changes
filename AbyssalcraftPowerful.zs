// recipes.addShaped(<abyssalcraft:soulreaper>.withTag({ench: [{lvl: 8 as short, id: 99 as short}, {lvl: 10 as short, id: 22 as short}, {lvl: 1 as short, id: 70 as short}], RepairCost: 1, display: {Name: "Vrangr"}}),
