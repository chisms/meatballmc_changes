mods.techreborn.industrialGrinder.addRecipe(<contenttweaker:gravitite_deposit>*4, <contenttweaker:gravitite_pearl>, <aether_legacy:golden_amber>, null, <contenttweaker:dense_gravitite_ore>, <ore:ballElectricalSteel>, <fluid:astralsorcery.liquidstarlight>*5, 10, 3000);
...
mods.techreborn.implosionCompressor.addRecipe(<aether_legacy:enchanted_gravitite>, <advancedrocketry:misc:1>, <contenttweaker:gravitite_dust>, <ore:dustDiamond>, 10, 3000);