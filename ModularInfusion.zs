...
reci2.addItemInput(makeVisCrystal(<aspect:vitreus> * 1)*30);
reci2.addItemInput(makeVisCrystal(<aspect:metallum> * 1)*30);
reci2.addItemInput(makeVisCrystal(<aspect:potentia> * 1)*15);
reci2.addItemInput(makeVisCrystal(<aspect:alienis> * 1)*10);
reci2.addItemInput(makeVisCrystal(<aspect:praecantatio> * 1)*10);
...
reci3.addItemInput(makeVisCrystal(<aspect:spiritus> * 1)*120);
reci3.addItemInput(makeVisCrystal(<aspect:victus> * 1)*100);
reci3.addItemInput(makeVisCrystal(<aspect:praecantatio> * 1)*100);
reci3.addItemInput(makeVisCrystal(<aspect:infernum> * 1)*100);
reci3.addItemInput(makeVisCrystal(<aspect:permutatio> * 1)*40);
reci3.addItemInput(makeVisCrystal(<aspect:metallum> * 1)*40);
reci3.addItemInput(makeVisCrystal(<aspect:alkimia> * 1)*30);
reci3.addItemInput(makeVisCrystal(<aspect:draco> * 1)*20);
reci3.addItemInput(makeVisCrystal(<aspect:visum> * 1)*20);
...
reci4.addItemInput(makeVisCrystal(<aspect:praecantatio> * 1)*120);
reci4.addItemInput(makeVisCrystal(<aspect:victus> * 1)*90);
reci4.addItemInput(makeVisCrystal(<aspect:metallum> * 1)*60);
reci4.addItemInput(makeVisCrystal(<aspect:caeles> * 1)*10);
...
reci5.addItemInput(makeVisCrystal(<aspect:aqua> * 1)*40);
reci5.addItemInput(makeVisCrystal(<aspect:alkimia> * 1)*32);
reci5.addItemInput(makeVisCrystal(<aspect:vacuos> * 1)*30);
reci5.addItemInput(makeVisCrystal(<aspect:caeles> * 1)*16);
reci5.addItemInput(makeVisCrystal(<aspect:permutatio> * 1)*10);
...
reci6.addItemInput(makeVisCrystal(<aspect:ordo> * 1)*50);
reci6.addItemInput(makeVisCrystal(<aspect:praecantatio> * 1)*25);
...
reci7.addItemInput(makeVisCrystal(<aspect:vacuos> * 1)*100);
reci7.addItemInput(makeVisCrystal(<aspect:ordo> * 1)*50);
reci7.addItemInput(makeVisCrystal(<aspect:praecantatio> * 1)*25);
...
reci8.addItemInput(makeVisCrystal(<aspect:vitium> * 1)*30);
reci8.addItemInput(makeVisCrystal(<aspect:perditio> * 1)*56);
reci8.addItemInput(makeVisCrystal(<aspect:alienis> * 1)*25);
reci8.addItemInput(makeVisCrystal(<aspect:cognitio> * 1)*30);
...
reci9.addItemInput(makeVisCrystal(<aspect:vitium> * 1)*50);
reci9.addItemInput(makeVisCrystal(<aspect:perditio> * 1)*56);
reci9.addItemInput(makeVisCrystal(<aspect:alienis> * 1)*32);
reci9.addItemInput(makeVisCrystal(<aspect:cognitio> * 1)*40);
...
reci10.addItemInput(makeVisCrystal(<aspect:vitium> * 1)*20);
reci10.addItemInput(makeVisCrystal(<aspect:perditio> * 1)*20);
reci10.addItemInput(makeVisCrystal(<aspect:alienis> * 1)*20);
reci10.addItemInput(makeVisCrystal(<aspect:cognitio> * 1)*20);
...
reci11.addItemInput(makeVisCrystal(<aspect:vitium> * 1)*50);
reci11.addItemInput(makeVisCrystal(<aspect:alienis> * 1)*50);
...
reci12.addItemInput(makeVisCrystal(<aspect:aer> * 1)*5);
reci12.addItemInput(makeVisCrystal(<aspect:terra> * 1)*5);
reci12.addItemInput(makeVisCrystal(<aspect:ignis> * 1)*5);
reci12.addItemInput(makeVisCrystal(<aspect:aqua> * 1)*5);
reci12.addItemInput(makeVisCrystal(<aspect:ordo> * 1)*5);
reci12.addItemInput(makeVisCrystal(<aspect:perditio> * 1)*5);
...
reci14.addItemInput(makeVisCrystal(<aspect:infernum> * 1)*100);
reci14.addItemInput(makeVisCrystal(<aspect:imperium> * 1)*50);
reci14.addItemInput(makeVisCrystal(<aspect:humanus> * 1)*30);
reci14.addItemInput(makeVisCrystal(<aspect:bestia> * 1)*25);
reci14.addItemInput(makeVisCrystal(<aspect:spiritus> * 1)*20);
reci14.addItemInput(makeVisCrystal(<aspect:victus> * 1)*15);
reci14.addItemInput(makeVisCrystal(<aspect:draco> * 1)*10);
reci14.addItemInput(makeVisCrystal(<aspect:exitium> * 1)*10);
...
reci26.addItemInput(makeVisCrystal(<aspect:aer> * 1)*10);
reci26.addItemInput(makeVisCrystal(<aspect:aqua> * 1)*10);
reci26.addItemInput(makeVisCrystal(<aspect:ordo> * 1)*10);
reci26.addItemInput(makeVisCrystal(<aspect:perditio> * 1)*10);
reci26.addItemInput(makeVisCrystal(<aspect:ignis> * 1)*10);
reci26.addItemInput(makeVisCrystal(<aspect:terra> * 1)*10);
reci26.addItemInput(makeVisCrystal(<aspect:imperium> * 1)*10);
...
reci32.addItemInput(makeVisCrystal(<aspect:bestia> * 1)*20);
reci32.addItemInput(makeVisCrystal(<aspect:lux> * 1)*15);
reci32.addItemInput(makeVisCrystal(<aspect:victus> * 1)*15);
reci32.addItemInput(makeVisCrystal(<aspect:desiderium> * 1)*15);
reci32.addItemInput(makeVisCrystal(<aspect:ignis> * 1)*2);
...
reci33.addItemInput(makeVisCrystal(<aspect:herba> * 1)*20);
reci33.addItemInput(makeVisCrystal(<aspect:lux> * 1)*15);
reci33.addItemInput(makeVisCrystal(<aspect:victus> * 1)*15);
reci33.addItemInput(makeVisCrystal(<aspect:instrumentum> * 1)*15);
reci33.addItemInput(makeVisCrystal(<aspect:terra> * 1)*2);
...
reci38.addItemInput(makeVisCrystal(<aspect:potentia> * 1)*100);
reci38.addItemInput(makeVisCrystal(<aspect:vacuos> * 1)*50);
reci38.addItemInput(makeVisCrystal(<aspect:alienis> * 1)*25);
...
reci39.addItemInput(makeVisCrystal(<aspect:motus> * 1)*25);
reci39.addItemInput(makeVisCrystal(<aspect:permutatio> * 1)*25);
reci39.addItemInput(makeVisCrystal(<aspect:potentia> * 1)*25);
...
reci41.addItemInput(makeVisCrystal(<aspect:spiritus> * 1)*250);
reci41.addItemInput(makeVisCrystal(<aspect:lux> * 1)*125);
reci41.addItemInput(makeVisCrystal(<aspect:humanus> * 1)*125);
...
reci49.addItemInput(makeVisCrystal(<aspect:alienis> * 1)*75);
reci49.addItemInput(makeVisCrystal(<aspect:vacuos> * 1)*75);
reci49.addItemInput(makeVisCrystal(<aspect:potentia> * 1)*50);
...
reci50.addItemInput(makeVisCrystal(<aspect:cognitio> * 1)*150);
reci50.addItemInput(makeVisCrystal(<aspect:vacuos> * 1)*150);
reci50.addItemInput(makeVisCrystal(<aspect:praecantatio> * 1)*100);
...
reci51.addItemInput(makeVisCrystal(<aspect:aversio> * 1)*150);
reci51.addItemInput(makeVisCrystal(<aspect:instrumentum> * 1)*150);
reci51.addItemInput(makeVisCrystal(<aspect:praecantatio> * 1)*100);
...
reci52.addItemInput(makeVisCrystal(<aspect:spiritus> * 1)*150);
reci52.addItemInput(makeVisCrystal(<aspect:instrumentum> * 1)*100);
...
reci53.addItemInput(makeVisCrystal(<aspect:aversio> * 1)*250);
reci53.addItemInput(makeVisCrystal(<aspect:infernum> * 1)*150);
...
reci54.addItemInput(makeVisCrystal(<aspect:aversio> * 1)*150);
reci54.addItemInput(makeVisCrystal(<aspect:infernum> * 1)*90);
reci54.addItemInput(makeVisCrystal(<aspect:praecantatio> * 1)*70);
reci54.addItemInput(makeVisCrystal(<aspect:metallum> * 1)*60);
reci54.addItemInput(makeVisCrystal(<aspect:draco> * 1)*40);
...
reci58.addItemInput(makeVisCrystal(<aspect:sol> * 1)*200);
reci58.addItemInput(makeVisCrystal(<aspect:imperium> * 1)*100);
reci58.addItemInput(makeVisCrystal(<aspect:sensus> * 1)*50);
...
inf61.addItemInput(makeVisCrystal(<aspect:motus> * 1)*25);
inf61.addItemInput(makeVisCrystal(<aspect:tenebrae> * 1)*25);
inf61.addItemInput(makeVisCrystal(<aspect:permutatio> * 1)*50);
...
inf62.addItemInput(makeVisCrystal(<aspect:auram> * 1)*10);
...
val inf63 = RecipeBuilder.newBuilder("inf63","arcane_autoinfuser",120);
inf63.addEnergyPerTickInput(100);
inf63.addItemInput(makeVisCrystal(<aspect:herba> * 1)*10);
inf63.addItemInput(makeVisCrystal(<aspect:sensus> * 1)*10);
inf63.addItemInput(makeVisCrystal(<aspect:humanus> * 1)*10);
inf63.addItemInput(<thaumcraft:seal:0>);
inf63.addItemInput(<minecraft:reeds>);
inf63.addItemInput(<minecraft:cactus>);
inf63.addItemInput(<minecraft:wheat_seeds>);
inf63.addItemInput(<minecraft:pumpkin_seeds>);
inf63.addItemInput(<minecraft:melon_seeds>);
inf63.addItemInput(<minecraft:beetroot_seeds>);
inf63.addItemOutput(<thaumcraft:seal:10>);
inf63.build();

val inf64 = RecipeBuilder.newBuilder("inf64","arcane_autoinfuser",120);
inf64.addEnergyPerTickInput(100);
inf64.addItemInput(makeVisCrystal(<aspect:sensus> * 1)*10);
inf64.addItemInput(makeVisCrystal(<aspect:cognitio> * 1)*10);
inf64.addItemInput(makeVisCrystal(<aspect:desiderium> * 1)*10);
inf64.addItemInput(<thaumcraft:seal:0>);
inf64.addItemInput(<ore:paper>*2);
inf64.addItemInput(<minecraft:writable_book>);
inf64.addItemInput(<thaumcraft:mind:1>);
inf64.addItemOutput(<thaumcraft:seal:1>);
inf64.build();

val inf65 = RecipeBuilder.newBuilder("inf65","arcane_autoinfuser",120);
inf65.addEnergyPerTickInput(100);
inf65.addItemInput(makeVisCrystal(<aspect:cognitio> * 1)*50);
inf65.addItemInput(makeVisCrystal(<aspect:machina> * 1)*25);
inf65.addItemInput(<thaumcraft:mind:0>);
inf65.addItemInput(<thaumcraft:mechanism_complex>);
inf65.addItemInput(<thaumcraft:brain>);
inf65.addItemOutput(<thaumcraft:mind:1>);
inf65.build();

val inf66 = RecipeBuilder.newBuilder("inf66","arcane_autoinfuser",120);
inf66.addEnergyPerTickInput(100);
inf66.addItemInput(makeVisCrystal(<aspect:bestia> * 1)*10);
inf66.addItemInput(makeVisCrystal(<aspect:sensus> * 1)*10);
inf66.addItemInput(makeVisCrystal(<aspect:humanus> * 1)*10);
inf66.addItemInput(<thaumcraft:seal:12>);
inf66.addItemInput(<minecraft:beef>);
inf66.addItemInput(<minecraft:rabbit_hide>);
inf66.addItemInput(<minecraft:leather>);
inf66.addItemInput(<minecraft:porkchop>);
inf66.addItemInput(<minecraft:mutton>);
inf66.addItemInput(<ore:wool>);
inf66.addItemOutput(<thaumcraft:seal:11>);
inf66.build();

val inf67 = RecipeBuilder.newBuilder("inf67","arcane_autoinfuser",120);
inf67.addEnergyPerTickInput(100);
inf67.addItemInput(makeVisCrystal(<aspect:instrumentum> * 1)*10);
inf67.addItemInput(makeVisCrystal(<aspect:perditio> * 1)*10);
inf67.addItemInput(makeVisCrystal(<aspect:humanus> * 1)*10);
inf67.addItemInput(<thaumcraft:seal:0>);
inf67.addItemInput(<minecraft:golden_pickaxe>);
inf67.addItemInput(<minecraft:golden_axe>);
inf67.addItemInput(<minecraft:golden_shovel>);
inf67.addItemOutput(<thaumcraft:seal:15>);
inf67.build();



val inf68 = RecipeBuilder.newBuilder("inf68","arcane_autoinfuser",120);
inf68.addEnergyPerTickInput(100);
inf68.addItemInput(<contenttweaker:bestia_vis_condensate>);
inf68.addItemInput(<twilightforest:alpha_fur>);
inf68.addItemInput(<contenttweaker:master_spell_focus>);
